      ...
      <div className="container mx-auto px-8 lg:px-16 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            {/* Testimonial Card */}
            <div className="bg-white/90 backdrop-blur-sm rounded-[2rem] shadow-botanical p-8 md:p-12 min-h-[480px] sm:min-h-[420px] md:min-h-[380px] flex flex-col justify-center overflow-hidden relative">
              {/* Large quote mark */}
